  ...
  private void cellTableStyleInitializer() {
    cellTableStyle = new com.google.gwt.user.cellview.client.CellTable.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GOWSV4FBED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GOWSV4FBFD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("right")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GOWSV4FBOC{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GOWSV4FBDE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GOWSV4FBDE:hover{color:" + ("#6c6b6b")  + ";}.GOWSV4FBPC{background:" + ("#fff")  + ";}.GOWSV4FBAD{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GOWSV4FBPD{background:" + ("#f3f7fb")  + ";}.GOWSV4FBAE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GOWSV4FBGD{background:" + ("#eee")  + ";}.GOWSV4FBHD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GOWSV4FBJD{background:" + ("#ffc")  + ";}.GOWSV4FBKD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GOWSV4FBBE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GOWSV4FBCE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GOWSV4FBID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GOWSV4FBOD{margin:") + (("30px")  + ";}")) : ((".GOWSV4FBED{border-top:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:" + ("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GOWSV4FBFD{border-bottom:" + ("2px"+ " " +"solid"+ " " +"#6f7277")  + ";padding:" + ("3px"+ " " +"15px")  + ";text-align:" + ("left")  + ";color:" + ("#4b4a4a")  + ";text-shadow:") + (("#ddf"+ " " +"1px"+ " " +"1px"+ " " +"0")  + ";overflow:" + ("hidden")  + ";}.GOWSV4FBOC{padding:" + ("2px"+ " " +"15px")  + ";overflow:" + ("hidden")  + ";}.GOWSV4FBDE{cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";}.GOWSV4FBDE:hover{color:" + ("#6c6b6b")  + ";}.GOWSV4FBPC{background:" + ("#fff")  + ";}.GOWSV4FBAD{border:" + ("2px"+ " " +"solid"+ " " +"#fff")  + ";}.GOWSV4FBPD{background:" + ("#f3f7fb")  + ";}.GOWSV4FBAE{border:" + ("2px"+ " " +"solid"+ " " +"#f3f7fb") ) + (";}.GOWSV4FBGD{background:" + ("#eee")  + ";}.GOWSV4FBHD{border:" + ("2px"+ " " +"solid"+ " " +"#eee")  + ";}.GOWSV4FBJD{background:" + ("#ffc")  + ";}.GOWSV4FBKD{border:" + ("2px"+ " " +"solid"+ " " +"#ffc")  + ";}.GOWSV4FBBE{background:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("auto")  + ";}.GOWSV4FBCE{border:" + ("2px"+ " " +"solid"+ " " +"#628cd5")  + ";}.GOWSV4FBID{border:" + ("2px"+ " " +"solid"+ " " +"#d7dde8")  + ";}.GOWSV4FBOD{margin:") + (("30px")  + ";}"));
      }
